      ...
      <form onSubmit={handleSubmit}>
        <div className="form-row">
            ...
            <input
              ...
              maxLength={
                perfil.tipo_documento === "DNI"
                  ? 8
                  : perfil.tipo_documento === "Carné de extranjería" ||
                    perfil.tipo_documento === "Pasaporte"
                    ? 12
                    : 20 // valor por defecto en caso de que no esté seleccionado
              }
            />
          </div>
          <div className="form-col-6">
          ...
          <div className="form-col-6">
            ...
            <input type="text" name="telefono" value={perfil.telefono} onChange={handleChange} maxLength={9} />
          </div>
          <div className="form-col-6">
